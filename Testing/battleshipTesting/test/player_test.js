...
describe("PLAYER METHODS", function() {
  describe("validateLocation", function() {
    var validateLocation = require("../gameLogic/playerMethods.js")
      .validateLocation;
    var player;
  ...
  describe("validateLocations", function() {
    var validateLocations = require("../gameLogic/playerMethods.js")
      .validateLocations;
    var player;
  ...
  describe("placeShip", function() {
    var placeShip = require("../gameLogic/playerMethods.js").placeShip;
    var player;
